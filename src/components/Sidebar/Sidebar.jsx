...
export default function Sidebar({ isOpen, onToggle }) {
  ...
  return (
    <>
      ...
      <div
        className={`w-64 bg-white border-r border-gray-200 h-screen fixed top-0 left-0 z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        {/* Logo */}
        <div className="px-6 py-2 lg:py-[11.8px] border-b border-gray-200 m-auto">
